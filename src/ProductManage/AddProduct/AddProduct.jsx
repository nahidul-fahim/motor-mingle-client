...
const AddProduct = () => {
    ...
    return (
        <div className="container mx-auto p-5 mt-[70px] md:mt-[80px]">
            <h2 className="text-center text-4xl md:text-5xl font-extrabold text-main font-heading uppercase">Add a new product</h2>
            <form id='productAddingForm' onSubmit={handleAddProduct}
                ...
                <input type="submit" value="Add the Product" className="w-full lg:w-2/3 px-5 py-3 bg-sub mt-5 rounded-md text-white hover:bg-main duration-300 font-heading font-semibold text-xl" />
            </form>
