    ...
    return (
        <div className="container mx-auto p-5">
            ...
            <div className="space-y-14 flex flex-col justify-center items-center">
                <h2 className="text-3xl text-main font-bold text-center font-heading">Sign up for free!</h2>

                <form onSubmit={handleSignUp} className="flex flex-col justify-center items-center w-full md:w-2/3 lg:w-1/3 space-y-7 lg:space-y-10 px-10 font-body">
                    ...
                    <input type="submit" value="Sign up" className="bg-main px-4 py-2 rounded text-white font-bold font-heading hover:bg-sub duration-300 w-full" />
            ...
            <div className="flex justify-center items-center flex-col">
                <div className="mt-5 flex justify-center items-center gap-1">
                    <p className="text-center font-semibold font-heading">Already have an account?</p>
                    <Link to="/login" className="font-bold font-heading border-t-2 border-t-[#ffffff00] border-b-2 border-main hover:bg-main hover:text-white px-2 py-1 hover:border-t-2 duration-300">Login</Link>
                </div>
            </div>
