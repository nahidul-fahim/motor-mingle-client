...
const Header = () => {
    ...
    // Changing theme on toggle button click
                ...
                <div className="navbar-start">
                    ...
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-5 shadow bg-base-100 rounded-box w-52  text-base font-semibold space-y-4">
                            {links}
                            <div className="flex justify-center items-center gap-1 ml-[-60px]">
                                <h2>Theme</h2>
                                ...
                                <label className="swap swap-rotate ml-5">
                                    ...
                                    <input type="checkbox" onChange={handleThemeToggle} defaultChecked={currentTheme === "dark"}/>
