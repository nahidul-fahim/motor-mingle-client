...
const SingleProductPage = ({ singleCategoryCar }) => {
    ...
    const { productName, brandName, carType, productPrice, rating, description, photo, _id } = singleCategoryCar;
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-10 h-[380px] bg-[#ff19662f] rounded-t-lg p-10 lg:p-0">
                <div className="space-y-3">
                    ...
                    <div className="flex justify-center items-start gap-3">
                        <Link><button className="bg-sub px-4 py-1 text-base font-body font-bold rounded text-white hover:bg-main duration-300">See Details</button></Link>
