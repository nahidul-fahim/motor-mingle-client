...
const SingleCartData = ({ singleCart, remainingProducts }) => {
    ...
    return (
        <div className='flex flex-col justify-center items-center gap-3 p-10 rounded-lg duration-500'>
            ...
            <button onClick={() => handleRemoveProduct(_id)} className='bg-sub px-4 py-2 font-heading font-semibold text-white mt-[1rem] hover:shadow-[0_60px_40px_#FF8FB2FF] hover:bg-main rounded duration-300'>Remove from Cart</button>
        </div>
    );
};
